...
import { MdxTabs, MdxMenu, MdxInformer, MdxCollapse } from '@consta/stand';
...
<MdxCollapse label="Пример с наведением и выбором строки">
...
<MdxCollapse label="Пример автоматического способа">
...
<MdxCollapse label="Пример подконтрольного способа">
...
<MdxCollapse label="Пример с использованием стейт-менеджера">
...
<MdxCollapse label="Пример с inside">
...
<MdxCollapse label="Пример с outside">
...
<MdxCollapse label="Пример со всплывающими подсказками">
