...
Где `width` это желаемая ширина колонки, если все колонки будут помещатся втаблицу без скролла она останется не изменной,
...
| `rows?`            | `ROW[]`                       | -            | Строки                                        |
| `onRowMouseEnter?` | `TableRowMouseEvent<ROW>`     | -            | Собитие `onMouseEnter` на строке              |
| `onRowMouseLeave?` | `TableRowMouseEvent<ROW>`     | -            | Собитие `onMouseLeave` на строке              |
| `onRowClick?`      | `TableRowMouseEvent<ROW>`     | -            | Собитие `onClick` на строке                   |
